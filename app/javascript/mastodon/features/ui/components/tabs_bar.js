...
export const links = [
  <NavLink className='tabs-bar__link' to='https://pumpitbetter.com/workouts' data-preview-title-id='column.workout' data-preview-icon='heartbeat' ><Icon id='heartbeat' fixedWidth /><FormattedMessage id='tabs_bar.workout' defaultMessage='Workout' /></NavLink>,
  <NavLink className='tabs-bar__link' to='/home' data-preview-title-id='column.feed' data-preview-icon='home' ><Icon id='home' fixedWidth /><FormattedMessage id='tabs_bar.feed' defaultMessage='Feed' /></NavLink>,
